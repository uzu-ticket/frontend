...
// Mock - in production this would be fetched by route.params.id
...
const activities = ref<CustomerActivity[]>([
  { id: 'a1', date: 'Sept 23, 2026', description: 'Early Bird Ticket for Summer Tech Conference Sold out' },
  { id: 'a2', date: 'Sept 10, 2026', description: 'Purchased 2 VIP tickets for Music Fest 2026' },
  { id: 'a3', date: 'Aug 20, 2026', description: 'Account created and verified' },
])
