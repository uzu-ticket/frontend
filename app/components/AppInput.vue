<template>
  <div :class="wrapperClasses">
    ...
    <div
      class="relative flex items-stretch overflow-hidden rounded-[14.76px] border border-gray-200 bg-white transition-all duration-200 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/30"
      :class="[
        props.error
    ...
    >
      <span
        v-if="prefix"
        class="flex shrink-0 items-center border-r border-gray-200 bg-white px-4 text-sm font-medium text-gray-600"
        :class="
          disabled ? 'bg-gray-100 text-gray-400' : 'bg-white text-gray-600'
        "
      >
        {{ prefix }}
      </span>
      ...
      <input
        ...
        :disabled="disabled"
        :readonly="readonly"
        class="block w-full bg-transparent text-gray-800 placeholder-gray-400 transition-all duration-200 focus:outline-none disabled:bg-gray-100 disabled:cursor-not-allowed"
        :class="[
          sizeClasses[props.size],
          prefix ? 'pl-4' : '',
          props.type === 'password' && !prefix ? 'pr-12' : 'pr-4',
        ]"
        @input="
...
const baseClasses =
  "block w-full bg-gray-50 rounded-[14.76px] border border-gray-100 text-gray-800 placeholder-gray-400 transition-all duration-200 focus:outline-none disabled:bg-gray-100 disabled:cursor-not-allowed";
